...
export class ZapierNLAWrapper {
    constructor(zapierNlaApiKey) {
        ...
        Object.defineProperty(this, "zapierNlaApiDynamicBase", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: "https://nla.zapier.com/api/v1/dynamic/"
        });
    ...
    async _getActionRequest(actionId, instructions, params) {
        ...
        const resp = await fetch(`${this.zapierNlaApiBase}exposed/${actionId}/execute/`, {
            method: "POST",
            headers,
